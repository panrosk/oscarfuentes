...
const Clippatheffect = () => {
  ...
  return (
    <>
      <img className='absolute top-0 left-0 w-full h-full object-cover ex final' src="https://images.unsplash.com/photo-1604964432806-254d07c11f32?q=80&w=2080&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="" />

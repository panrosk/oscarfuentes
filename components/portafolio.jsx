...
const Portafolio = () => {
  ...
  return (
    ...
    <section ref={containerref} className='relative bg-black h-full lg:p-[40px] w-full' id='portafolio'>
            ...
            <img ref={imagenref}  src="https://images.unsplash.com/photo-1648495754619-885ca69c1665?q=80&w=2942&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" className='w-2/3 lg:w-1/2 h-[600px] lg:h-[1500px]' alt="" />

        </div>
        <div className=' absolute flex items-start lg:items-center h-full   w-full '>
